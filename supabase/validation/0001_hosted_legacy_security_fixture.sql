-- Disposable hosted Supabase validation fixture only.
--
-- This file is not a production migration. It reproduces the known legacy
-- Honest Lenses application objects and intentionally vulnerable pre-
-- remediation grants in a brand-new hosted Supabase project. Unlike the local
-- fixture, it does not create or redefine Supabase-managed roles, auth
-- helpers, schemas, or storage tables.
