  ...
  return (
    <ModalShell isOpen={isOpen} onClose={onClose} labelledBy="shop-intent-title">
      <div className="modal-body">
        <h2 id="shop-intent-title">How would you like to browse?</h2>
        ...
        <button className="modal-primary" onClick={onJustLooking}>
          Browse lenses & prices
        </button>

        <div className="modal-divider" />

        <button className="modal-link" onClick={onHasPrescription}>
