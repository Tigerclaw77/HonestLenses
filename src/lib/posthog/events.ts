export const POSTHOG_EVENTS = {
  ...
  HONEST_PRICE_VIEWED: "honest_price_viewed",
  HONEST_PRICE_DETAILS_OPENED: "honest_price_details_opened",
  SAVE_CART_STARTED: "save_cart_started",
  SAVE_CART_COMPLETED: "save_cart_completed",
