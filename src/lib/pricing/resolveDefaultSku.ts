...
export const CORE_TO_SKUS: Record<string, string[]> = {
  ...
  OASYS_MAX_1D: ["OASYS_MAX_1D_30", "OASYS_MAX_1D_90"],
  OASYS_MAX_1D_AST: ["OASYS_MAX_1D_AST_30"],
  OASYS_MAX_1D_MF: ["OASYS_MAX_1D_MF_30", "OASYS_MAX_1D_MF_90"],
  OASYS_MAX_1D_AST_MF: ["OASYS_MAX_1D_AST_MF_30"],

  OASYS_1D: ["OASYS_1D_90"],
  OASYS_1D_AST: ["OASYS_1D_AST_30", "OASYS_1D_AST_90"],

  OASYS_2W: ["OASYS_2W_12", "OASYS_2W_24"],
